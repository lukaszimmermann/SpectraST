...
void SpectraSTDenoiserFeature::smoothLogOdds() {
  ...
  for (int index = 3; index < numBins - 3; index++) {
    logOdds[index] = (7 * smooth[index] + 6 * (smooth[index + 1] + smooth[index - 1]) + 
		      3 * (smooth[index + 2] + smooth[index - 2]) -2 * (smooth[index + 3] + smooth[index - 3])) / 21.0;
  }
  logOdds[numBins - 3] = (7 * smooth[numBins - 3] + 6 * (smooth[numBins - 2] + smooth[numBins - 4]) + 3 *(smooth[numBins - 1]+smooth[numBins - 5])-2 * smooth[numBins - 6]) / 23.0;
  logOdds[numBins - 2] = (7 * smooth[numBins - 2] + 6 * (smooth[numBins - 1] + smooth[numBins - 3]) + 3 * smooth[numBins - 4] - 2 * smooth[numBins - 5]) / 20.0;
  logOdds[numBins - 1] = (7 * smooth[numBins - 1] + 6 * smooth[numBins - 2] + 3 * smooth[numBins - 3] - 2 * smooth[numBins-4] ) / 14.0;
...
void SpectraSTDenoiser::useDefault() {
  ...
  float rankLogOdds[] = { 4.1824, 4.02584, 3.84031, 3.5457, 3.35526, 3.18706, 3.03382, 2.89556, 2.77159, 2.66182, 
			 ...
			 1.16323, 1.10972, 1.05745, 1.00635, 0.959576, 0.913063, 0.871409, 0.828742, 0.786954, 0.745091, 
			 0.706025, 0.661849, 0.619583, 0.582152, 0.546317, 0.510238, 0.473625, 0.432658, 0.394975, 0.359724, 
			 0.327071, 0.294045, 0.259905, 0.222172, 0.18875, 0.15242, 0.120852, 0.0919143, 0.0622389, 0.0316789, 
			 0.00160561, -0.0315469, -0.0628154, -0.0899432, -0.118559, -0.145458, -0.173643, -0.205532, -0.236153, -0.260781, 
			 -0.285765, -0.310873, -0.335457, -0.363311, -0.390157, -0.414493, -0.436925, -0.462431, -0.488903, -0.518141, 
			 -0.543916, -0.564566, -0.583791, -0.606335, -0.631028, -0.659311, -0.685798, -0.707176, -0.730214, -0.753894, 
			 -0.776487, -0.798325, -0.817541, -0.837389, -0.86271, -0.886906, -0.908754, -0.927517, -0.94514, -0.962288, 
			 -0.98413, -1.00636, -1.02599, -1.0492, -1.06794, -1.08414, -1.10186, -1.12213, -1.1424, -1.16392, 
			 -1.18125, -1.20071, -1.22033, -1.24009, -1.25914, -1.27765, -1.29749, -1.31712, -1.33935, -1.36006, 
			 -1.37792, -1.39782, -1.41187, -1.42653, -1.44253, -1.46037, -1.47889, -1.50016, -1.51232, -1.52873, 
			 -1.54191, -1.55834, -1.57326, -1.59346, -1.61403, -1.63503, -1.65719, -1.67541, -1.69187, -1.7045, 
			 -1.7241, -1.7407, -1.76292, -1.78104, -1.7984, -1.81121, -1.83015, -1.85384, -1.8699, -1.88268 };
  ...
  m_featureMzPos->initialize(100);
  float mzPosLogOdds[] =  { -1.34657, -1.34657, -1.34657, -1.34657, -1.37168, -1.31375, -1.30542, -1.23415, -1.11003, -0.972022,
			   -0.83933, -0.710855, -0.713758, -0.718696, -0.692271, -0.640897, -0.552938, -0.499806, -0.459431, -0.443607,	
			   -0.413077, -0.387957, -0.310813, -0.24045, -0.179349, -0.146892, -0.129763, -0.127471, -0.0766487, -0.0902686,
			   -0.0081166, -0.010562, -0.0261707, -0.0484099, -0.0616517, -0.114581, -0.0458415, -0.0315522, -0.00296058, 0.0309577, 
			   0.0819645, 0.126689, 0.156309, 0.154758, 0.127764, 0.0202552, -0.0550962, 0.146643, 0.234947, 0.24339, 
			   0.162565, -0.0596549, -0.232069, -0.126285, -0.106357, -0.0617923, 0.0420685, 0.0405285, -0.0501975, -0.0450146, 
			   -0.0446294, -0.0163725, 0.0113579, 0.0231656, 0.0449489, 0.0680706, 0.114268, 0.176331, 0.215261, 0.259835, 
			   0.329065, 0.375858, 0.42079, 0.432524, 0.427477, 0.447402, 0.463656, 0.471419, 0.493349, 0.518875, 
			   0.526353, 0.521248, 0.506394, 0.527454, 0.558109, 0.577996, 0.554414, 0.534352, 0.48976, 0.564687, 
			   0.364586, 0.00121955, -0.542152, -0.777207, -0.923613, -0.666413, -0.502393, -0.616991, -0.839414, -0.902675};
  ...
  float withSisterLogOdds[] = { 0.350278, 0.164399, 0.228062, 0.462959, 1.06885, 0.654958, 0.145021, 0.502616, 0.61074, 0.802457, 
			       0.200676, 0.22245, 0.195438, 0.0630093, 0.1806, 0.182611, 0.222371, 0.311623, 0.179564, 0.0406221,
			       0.455735, 0.396997, 0.320707, 0.214306, 0.383839, 0.383838, 0.416872, 0.334572, 0.084313, 0.382453, 
  ...
  float withoutSisterLogOdds[] = { -0.0873323, -0.0334474, -0.0434743, -0.094576, -0.440145, -0.270833, -0.0292009, -0.0967725, -0.126143, -0.201188, 
				   -0.0294654, -0.032661, -0.027162, -0.00764404, -0.023798, -0.0251726, -0.0302876, -0.0457539, -0.0238243, -0.00466176,
				   -0.0751136, -0.062578, -0.0470924, -0.027647, -0.0554484, -0.0554921, -0.0639662, -0.0461552, -0.00916711, -0.0518711,
...
void SpectraSTDenoiser::addTrainingSpectrum(SpectraSTPeakList* pl) {
  ...
  //    m_featureDeltaInt->incrementNoise(deltaIntBin);
	...
	double compMz = (precursorMass - thisPeak.mz * (double)thisCharge - (double)numLostProtons * ((*Peptide::AAMonoisotopicMassTable)['+'])) / (double)compCharge;
...
void SpectraSTDenoiser::generateBayesianModel() {
  ...
  */
  ...
  cout << "Generating Bayesian Model -- S=" << m_numSignal << "; N=" << m_numNoise << "; logO=" << logOddsPrior << endl;
...
//  m_featureDeltaInt->smoothLogOdds();
  ...
  int errorCode = gsl_multifit_linear_svd(gslDataMatrix, gslPriors, tolerance, &rank, gslRegressionCoefficients, gslRegressionCovMatrix, &chisq, priorFittingWorkSpace);
  ...
  for (unsigned int i = 0; i < m_priors.size(); i++) {
    ...
    errorCode = gsl_multifit_linear_est(gslPriorData, gslRegressionCoefficients, gslRegressionCovMatrix, &regressedPrior, &regressedPriorError);
...
//      }
  ...
  if (m_sisters.size() != m_featureWithSister->getNumBins() || m_sisters.size() != m_featureWithoutSister->getNumBins()) {
