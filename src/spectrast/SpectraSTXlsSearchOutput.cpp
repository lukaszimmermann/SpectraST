...
// constructor
SpectraSTXlsSearchOutput::SpectraSTXlsSearchOutput(string outFullFileName, string inputFileExt, SpectraSTSearchParams& searchParams, bool printHeader) :
...
void SpectraSTXlsSearchOutput::printStartQuery(string query, double precursorMz, int assumedCharge, double retentionTime) {
...
void SpectraSTXlsSearchOutput::printHit(string query, unsigned int hitRank, SpectraSTLibEntry* entry, SpectraSTSimScores& simScores) {
