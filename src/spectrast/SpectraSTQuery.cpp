...
// constructor - DDA
SpectraSTQuery::SpectraSTQuery(string prefix, int startScanNum, int endScanNum, double precursorMz, int charge, string comments, SpectraSTPeakList* peakList) : 
...
SpectraSTQuery::SpectraSTQuery(string prefix, int startScanNum, int endScanNum, double minPrecursorMz, double maxPrecursorMz, vector<double>* precursors, string comments, SpectraSTPeakList* peakList) :
...
bool SpectraSTQuery::parseQueryTPPStyle(string& query, string& prefix, int& firstScanNum, int& lastScanNum, int& charge) {
