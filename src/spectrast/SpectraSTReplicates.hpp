...
public:
  SpectraSTReplicates(vector<SpectraSTLibEntry*>& entries, SpectraSTCreateParams& params, vector<SpectraSTDenoiser*>* denoisers = NULL);
...
private:
  ...
  void aggregateStats(SpectraSTLibEntry* final, SpectraSTPeakList* pl, vector<Replicate*>& usedReps, bool isConsensus = true);
  void plotSingle(SpectraSTLibEntry* single);
  void plotConsensus(SpectraSTLibEntry* consensus, SpectraSTPeakList* consensusPeakList, vector<Replicate*>& usedReps);
  
  void processConsensus(SpectraSTLibEntry* consensus, SpectraSTPeakList* consensusPeakList, vector<Replicate*>& usedReps);
