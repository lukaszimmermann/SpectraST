...
/* GNU Config Parameters from system.h */
typedef void * ptr_t;
#ifndef PARAMS
# define PARAMS(x) x
#endif
...
/* Search through the given buffer for a member of the keyword set.
   Return a pointer to an array of kwsmatch objects...one for
   each hit found in the buffer */
int kwsexec_multiple(kwset_t, char const *, size_t, struct kwsmatch **);
