...
public:
  ...
  SpectraSTQuery(string prefix, int startScanNum, int endScanNum, double precursorMz, int charge, string comments, SpectraSTPeakList* peakList);
  
  // DIA query from mzXML
  SpectraSTQuery(string prefix, int startScanNum, int endScanNum, double minPrecursorMz, double maxPrecursorMz, vector<double>* precursors, string comments, SpectraSTPeakList* peakList);
