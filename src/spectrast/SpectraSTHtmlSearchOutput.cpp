...
// constructor
SpectraSTHtmlSearchOutput::SpectraSTHtmlSearchOutput(string outputFileName, string inputFileExt, SpectraSTSearchParams& searchParams) :
...
void SpectraSTHtmlSearchOutput::printHeader() {
 ...
 // (*m_fout) << "Content-type: text/html\n\n";
  (*m_fout) << "<HTML>" << endl;
  (*m_fout) << "  <HEAD>" << endl;
  (*m_fout) << "    <TITLE>" << "SpectraST Search Results: " << m_searchFile << " against " << m_searchParams.libraryFile << "</TITLE>" << endl;
  (*m_fout) << "  </HEAD>" << endl;
  (*m_fout) << endl;
...
void SpectraSTHtmlSearchOutput::printStartQuery(string query, double precursorMz, int assumedCharge, double retentionTime) {
...
void SpectraSTHtmlSearchOutput::printHit(string query, unsigned int hitRank, SpectraSTLibEntry* entry, SpectraSTSimScores& simScores) {
