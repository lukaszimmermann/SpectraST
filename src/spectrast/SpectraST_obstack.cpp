...
#if defined (__STANDARDC__) && __STANDARDC__
#define POINTER void *
#else
#define POINTER char *
#endif
...
#else
int
_obstack_begin (struct obstack *h, int size, int alignment, POINTER (*chunkfun) (), void (*freefun) ())
#endif
{
...
#else
int
_obstack_begin_1 (struct obstack *h, int size, int alignment, POINTER (*chunkfun) (), void (*freefun) (), POINTER arg)
#endif
{
  register struct _obstack_chunk *chunk; /* points to new chunk */
