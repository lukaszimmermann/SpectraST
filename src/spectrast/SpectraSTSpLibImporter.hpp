...
private:
  ...
  void generatePrecursorSwapDecoys(SpectraSTMzLibIndex* mzIndex, vector<SpectraSTLibEntry*>& entries, set<fstream::off_type>& usedEntries, double minMz, double maxMz);
