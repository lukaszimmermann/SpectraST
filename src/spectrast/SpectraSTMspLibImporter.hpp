#ifndef SPECTRASTMSPLIBIMPORTER_HPP_
#define SPECTRASTMSPLIBIMPORTER_HPP_
...
class SpectraSTMspLibImporter : public SpectraSTLibImporter { 

public:

  SpectraSTMspLibImporter(vector<string>& impFileNames, SpectraSTLib* lib, SpectraSTCreateParams& params);
  virtual ~SpectraSTMspLibImporter();
  virtual void import();
