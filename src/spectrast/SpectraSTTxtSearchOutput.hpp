#ifndef SPECTRASTTXTSEARCHOUTPUT_HPP_
#define SPECTRASTTXTSEARCHOUTPUT_HPP_
...
class SpectraSTTxtSearchOutput : public SpectraSTSearchOutput {

public:
  SpectraSTTxtSearchOutput(string outFullFileName, string inputFileExt, SpectraSTSearchParams& searchParams, bool printHeader = true);
  virtual ~SpectraSTTxtSearchOutput();
...
#endif /*SPECTRASTTXTSEARCHOUTPUT_HPP_*/
