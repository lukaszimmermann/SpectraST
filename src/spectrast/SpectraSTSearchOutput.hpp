...
public:
	...
	virtual void printHit(string query, unsigned int hitRank, SpectraSTLibEntry* entry, SpectraSTSimScores& simScores) = 0;
	...
	static SpectraSTSearchOutput* createSpectraSTSearchOutput(string searchFileName, SpectraSTSearchParams& searchParams);
